import{i as e}from"./main-CcOVVAEj.js";document.getElementById("app").innerHTML=`
  <!-- Technology Hero -->
...
`;e("technology");const l=new IntersectionObserver(s=>{s.forEach(a=>{if(a.isIntersecting){const i=a.target;i.style.setProperty("--bar-width",i.dataset.width),i.classList.add("animate")}})},{threshold:.3});document.querySelectorAll(".metric-bar-fill").forEach(s=>l.observe(s));
